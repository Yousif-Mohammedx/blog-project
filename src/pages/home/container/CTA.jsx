            ...
            <section className='relative bg-dark-hard px-5'>
                <div className='container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center'>
                    <div className='col-span-12 lg:col-span-6'>
                        ...
                        <p className='text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left '> <span className='font-bold italic text-[#B3BAC5] md:not-italic md:font-normal md:text-dark-light'>Get a response tomorrow</span> if you submit by 9pm today. If we received after 9pm will get a reponse the following day.</p>
                    </div>
                    <div className='col-span-12 hidden mb-[70px] md:block md:order-first lg:col-span-6 lg:order-last'>
                        <div className='w-3/4 mx-auto relative'>
                            ...
                            >
                                <img src={images.CtaImage} alt='title' className='w-full object-cover object-center h-auto md:h-52 lg:h-48 xl:h-60'></img>
                                <div className='p-5'>
                                    <h2 className='font-roboto font-bold text-xl text-dark-soft md:text-2xl lg:text-[28px]'>
                                        Future of Work
                                    </h2>
                                    <p className='text-dark-light mt-3 text-sm md:text-lg'>Majority of people will work in jobs that don't exit today</p>
                                </div>
                            </div>
                        </div>
                    </div>
